...
| 구분                    | 개발기간             | 내용                                                                                                                                                                                           |
| ----------------------- | -------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **원본 팀 프로젝트**    | 2026.04.20 ~ 05.07   | 5인 팀 · 담당: 랜딩 페이지 · 공통 컴포넌트(Button · DeleteAlertModal) · 브라우저 자동완성 대응 · 컬럼 수정 · 컬럼 삭제 · 프로필 변경 · [Taskify](https://github.com/Useung0830/2-team-taskify) |
